...
COPY --from=build /work/target/release/hhm-dioxus-web /usr/local/bin/hhm-dioxus-web
USER app
...
ENTRYPOINT ["/usr/local/bin/sops-entrypoint.sh", "/usr/local/bin/hhm-dioxus-web"]
